...
class MPF_MDR_Model(nn.Module):
    def __init__(self, **params):
        ...
        self.mulit_modal_features = self.text_features
        # domain prompt
    ...
    def forward(self, nodes_u, nodes_v, nodes_d, top_n_index, prototypes):
        ...
        inter_top_n_merge_index = [torch.unique(text_idx.flatten()) for text_idx in inter_top_n_index_text]
        ...
        h_u_final = self.beta*p_u+(1-self.beta)*h_u
