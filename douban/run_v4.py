...
if __name__ == '__main__':
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if hr > best_hr:
            ...
            with open(f'best_model/{domains}_b_{args.batch_size}_d_{args.prompt_dim}_'
                       f'delta_{args.delta}_k_{args.k}_n_{args.n}_cluster_center_dict_12_16.pkl','wb') as f:
                pickle.dump(cluster_center_dict,f)
            torch.save(model.state_dict(),
                       f'best_model/{domains}_b_{args.batch_size}_d_{args.prompt_dim}_'
                       f'delta_{args.delta}_k_{args.k}_n_{args.n}_12_16.pth')
            # np.save(
