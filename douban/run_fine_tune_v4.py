...
if __name__ == '__main__':
    ...
    load_data_params = {
        ...
        'train_path': f'{path}/tune/{dataset}/train.csv',
        'test_path': f'{path}/tune/{dataset}/test.csv',
        'args': args,
        'test_neg_path': f'{path}/tune/{dataset}/test.txt',
        'test_neg_path_zero_shot': f'{path}/tune/{dataset}/test_zero_shot.txt',
        'test_neg_path_few_shot': f'{path}/tune/{dataset}/test_few_shot.txt',
        'test_neg_path_warm_shot': f'{path}/tune/{dataset}/test_warm_shot.txt',
    }
    ...
    # with open(
    #         'best_model_v4/health_cloth_beauty_b_2048_d_256_delta_0.5_k_10_n_1_cluster_center_dict_11_08.pkl', 'rb') as f:
    #     cluster_center_dict = pickle.load(f)
    ...
    pretrain_dict = torch.load(
        'best_model/book_movie_music_b_2048_d_256_delta_0.5_k_10_n_1_12_16.pth', map_location=lambda storage, loc: storage)
