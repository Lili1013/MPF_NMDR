...
if __name__ == '__main__':
    ...
    multi_modal_path = f'/data/lwang9/CDR_data_process/data_process_MPF_MDR/datasets/douban_review'
    load_data_params = {
        'rating_path': f'{path}/single/{dataset}/{dataset}_inter.csv',
        'text_feat_path': f'{path}/single/{dataset}/{dataset}_text_features.npy',
        # 'visual_feat_path': f'{path}/{domains}_single/{dataset}/{dataset}_image_features.npy',
        'train_path': f'{path}/single/{dataset}/train.csv',
        'test_path': f'{path}/single/{dataset}/test.csv',
        'args': args,
        # 'test_neg_path': f'{path}/{domains}_single/{dataset}/test.txt',
        'test_neg_path_zero_shot': f'{path}/single/{dataset}/test_zero_shot.txt',
        'test_neg_path_few_shot': f'{path}/single/{dataset}/test_few_shot.txt',
        'test_neg_path_warm_shot': f'{path}/single/{dataset}/test_warm_shot.txt',
    }
