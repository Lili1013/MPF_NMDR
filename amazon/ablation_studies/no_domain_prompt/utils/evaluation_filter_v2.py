...
def calculate_hr_ndcg(model, test_ratings, test_negatives, k,device,cluster_center_dict,user_cat):
    global _model
...
def pred_one_user(u_id, items,domain_id):
    ...
    pred_prob,p_u,p_v,p_d= _model.forward(user_id_input, item_id_input,domain_id_input,_cluster_center_dict)
    return pred_prob
...
def pred_one_user_zero_shot(u_id, items,domain_id):
    ...
    pred_prob,p_u,p_v,p_d= _model.forward_zero_shot(user_id_input, item_id_input,domain_id_input,_cluster_center_dict)
    return pred_prob
