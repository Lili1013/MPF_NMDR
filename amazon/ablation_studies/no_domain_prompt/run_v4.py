...
if __name__ == '__main__':
    ...
    for epoch in range(1, args.epochs + 1):
        if endure_num >= 5:
            logger.info('End')
            break
        total_loss,total_main_loss,cluster_assignments,cluster_center_dict = train(args, model, load_data,optimizer,device)
        ...
        if hr > best_hr:
            ...
            torch.save(model.state_dict(),
                       ...
                       f'delta_{args.delta}_k_{args.k}_n_{args.n}_11_16.pth')
            # np.save(
